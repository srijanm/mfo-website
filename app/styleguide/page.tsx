  ...
  return (
    <Container className={styles.page}>
      ...
      <p className={styles.pageIntro}>
        Every foundation primitive and information object, in every state. This
        page is the visual anchor for the build: if something renders correctly
        here and nowhere else, the section is wrong, not the primitive.
      </p>

      <Section labelledBy="colour" className={styles.group}>
      ...
      <Section labelledBy="type" className={styles.group}>
      ...
      <Section labelledBy="grid" className={styles.group}>
      ...
      <Section labelledBy="rules" className={styles.group}>
        ...
        <div className={styles.stack}>
          ...
          <Specimen state="VerticalRule — desktop only" wide>
            <div className={styles.split}>
              <p className={styles.splitPane}>
                Left pane. On desktop a 1px rule divides these two columns.
              </p>
              <VerticalRule />
              <p className={styles.splitPane}>
                Right pane. Below 1024px the rule is removed and the panes
                stack.
              </p>
            </div>
          </Specimen>
      ...
      <Section labelledBy="threshold" className={styles.group}>
      ...
      <Section labelledBy="actions" className={styles.group}>
      ...
      <Section labelledBy="disclosure" className={styles.group}>
      ...
      <Section labelledBy="objects" className={styles.group}>
      ...
      <Section labelledBy="reviewed" className={styles.group}>
